...
# choc-performance-tests

Performance test suite for the `bank-account-coc`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
...
Start `BA_COC` services as follows:
